...
class ConnectorOperation {
    ...
    getById(id, convert = true){
        return this.model.findOne({
            where: {
                id
            }
        }).then(operation => convert ? ConnectorOperation.fromDBObject(operation) : operation);
    }
    ...
    getWithCustomWhere(where = {}){
        return this.model.findAll({where})
            .then(results => results.map(result => ConnectorOperation.fromDBObject(result)));
    }
    ...
    updateForId(id, object, convert = true){
        return this.model.update(convert ? ConnectorOperation.toDBObject(object) : object, {
            where: {
                id
            }
        });
    ...
    updateForName(name, object, convert = true){
        return this.model.update(convert ? ConnectorOperation.toDBObject(object) : object, {
            where: {
                name
            }
